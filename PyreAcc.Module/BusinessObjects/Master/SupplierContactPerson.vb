...
Public Class SupplierContactPerson
    ...
    Public Property Supplier As Supplier
        ...
        End Set
    End Property
    <RuleRequiredField("Rule Required for SupplierContactPerson.Note", DefaultContexts.Save)>
    Public Property Note As String
        ...
        End Set
    End Property
    <RuleRequiredField("Rule Required for SupplierContactPerson.ContactPerson", DefaultContexts.Save)>

...
<RuleCriteria("Rule Criteria for JournalEntryDebit.Amount > 0", DefaultContexts.Save, "Amount > 0")>
...
Public Class JournalEntryDebit
    ...
    Public Property Sequence As Integer
        ...
        End Set
    End Property
    <Association("JournalEntry-JournalEntryDebit")>
    <RuleRequiredField("Rule Required for JournalEntryDebit.JournalEntry", DefaultContexts.Save)>
        ...
        Set(ByVal value As JournalEntry)
            ...
            If Not IsLoading Then
                If JournalEntry IsNot Nothing Then
                    If JournalEntry.Debits.Count = 0 Then
                        Sequence = 0
                    Else
                        JournalEntry.Debits.Sorting = New SortingCollection(New SortProperty("Sequence", DB.SortingDirection.Ascending))
                        Sequence = JournalEntry.Debits(JournalEntry.Debits.Count - 1).Sequence + 1
                    End If
                End If
            End If
        End Set
